...
if "Zeichnen (Versuch 4)" not in st.session_state:
    st.session_state["Zeichnen (Versuch 4)"] = False
...
with colB:
    if st.button(label='Zeichnen (Versuch 4)', type='primary'):
        st.session_state['Zeichnen (Versuch 4)'] = not st.session_state['Zeichnen (Versuch 4)'] 
...
if st.session_state['Zeichnen (Versuch 4)']:
    with col1:
        st.write('')
    with col2:
        st.pyplot(fig1)
